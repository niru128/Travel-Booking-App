	...
	return (
		<div className="pt-5 px-[124px] pb-10 flex flex-col gap-4">
			...
			<div className="flex flex-row gap-10">
				{/* Left side: form */}
				<div className="flex flex-col w-[739px] rounded-xl py-5 px-6 gap-4 bg-[#EFEFEF]">
				...
				{/* Right side: summary */}
				<div className="w-[387px] h-[349px] rounded-xl p-6 flex flex-col bg-[#EFEFEF]">
					...
					<button
						...
						className="mt-6 py-3 px-4 rounded-lg h-11 w-full bg-[#FFd643] text-[#161616] text-[16px] font-medium hover:bg-amber-400"
					>
						Pay and Confirm
					</button>
				</div>
