            ...
            <div className='flex flex-row gap-4 '>
                ...
                <div className='flex-1'>
                    <img
                        ...
                        className='w-[765px] h-[381px] top-[155px] left-[124px] rounded-xl'
                    />
                                    ...
                                    {experience.availableSlots.map((slot, index) => (
                                        ...
                                        >
                                            <button
                                                ...
                                                className={`px-3 text-[#161616] py-2 border-[0.6px] rounded-sm h-[34px] w-[79px] font-medium text-[14px] leading-[18px] grow cursor-pointer 
      ${selectedDate === slot.date ? "bg-[#FFD643] text-[#161616] border-[#FF4C0A]" : "bg-[#FFFFFF] text-[#161616] border-gray-300"}
    `}
                                            >
                                                {slot.date}
                                            </button>
                            ...
                            <div className="flex flex-col gap-3 w-lg h-24">
                                <h2 className="font-inter font-medium text-[18px] leading-[22px] text-[#161616]">
                                    Choose Time
                                </h2>

                                <div className="flex gap-2 w-lg h-[34px] flex-row justify-evenly">
                                    {experience.availableSlots[0].times.map((timeObj, i) => {
                                        const isSoldOut = timeObj.status === "soldOut"; // optional
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`px-3 py-2 border-[0.6px] rounded-sm h-[34px] w-[69px] font-medium text-[14px] leading-[18px] grow cursor-pointer
                ${isSoldOut
                                ...
                                <div className="h-4 w-lg font-medium font-inter text-[12px] leading-4 text-[#838383]">
                ...
                <div className="w-[387px] h-fit bg-[#F9F9F9] rounded-xl p-6 flex flex-col justify-between border border-gray-200 shadow-sm">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="w-7 h-7 rounded-md border border-gray-300 flex items-center justify-center text-lg font-medium hover:bg-gray-100"
                                >
                                    –
                                </button>
                    ...
                    <button
                        ...
                        className={`mt-6 w-full py-3 rounded-lg font-semibold transition ${selectedDate && selectedTime
                            ? "bg-[#FFD643] text-[#161616] hover:bg-amber-300 cursor-pointer"
