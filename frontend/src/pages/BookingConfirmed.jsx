...
const BookingConfirmed = () => {
  ...
  return (
    ...
    <div className="pt-5 mt-10 px-[124px] pb-10 flex flex-col items-center gap-4">
      ...
      <button className="bg-gray-200 px-4 py-2 gap-2.5 rounded-sm font-medium text-[#656565] leading-5 tracking-normal text-[16px] mt-4 cursor-pointer hover:bg-gray-300" onClick={handleClick}>
        Back to Home
      </button>
    </div>
